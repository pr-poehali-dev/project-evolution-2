  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-12 pb-8 text-center">
      <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#1a1a1a] py-2 text-sm px-2">
        <span className="rounded-full bg-violet-500/20 px-2 py-0.5 text-xs font-medium text-violet-400">ДОХОДНОСТЬ</span>
        <span className="text-gray-300">До 34% годовых на проверенных стратегиях</span>
      ...
      <p className="mb-8 max-w-xl text-gray-400">Умные инвестиции, автоматические стратегии и прозрачная аналитика — всё в одной платформе.</p>
